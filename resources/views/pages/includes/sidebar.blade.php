               ...
               <div class="item post-37176">
                  <a href="{{route('movie',$hot_sidebar->slug)}}" title="{{$hot_sidebar->title}}">
                     <div class="item-link">
                        ...
                        <figure>
                           @php
                              $img = substr($hot_sidebar->image,0,5);
                           @endphp
                           @if($img != 'https')
                              <figure><img src="{{asset('uploads/movie/'.$hot_sidebar->image)}}" class="lazy post-thumb" alt="{{$hot_sidebar->title}}" title="{{$hot_sidebar->title}}"></figure>
                           @else
                              <figure><img src="{{$hot_sidebar->image}}" class="lazy post-thumb" alt="error" title="{{$hot_sidebar->title}}"></figure>
                           @endif
                        </figure>
