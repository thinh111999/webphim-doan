...
class MovieController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach($data['category'] as $key => $cate) { $movie->category_id = $cate[0]; }
    ...
    public function edit($id)
    {
        ...
        return view('admincp.movie.form', compact('category','genre','country','movie','list_genre','list_category','movie_genre', 'movie_category'));
    }
